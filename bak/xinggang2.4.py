...
# Internal filename: 'tafangtianqi.py'
...
def main():
    ...
    while True:
        ...
        if result:
            ...
            if 550 < xinit < 600 and 100 < yinit < 150:
                                                        ...
                                                        if result:
                                                            ...
                                                            if 460 < xinit < 530 and 200 < yinit < 280:
                                                                            ...
                                                                            for idx in indexes:
                                                                                ...
                                                                                base_y = ybase - 75
                                                                                click_at(x, base_y - 10, button='left', delay=0.1)
                                                                                time.sleep(0.5)
                                                                                click_at(x, base_y, button='left', delay=0.1)
                                                                                time.sleep(0.5)
                                                                                click_at(x, base_y + 10, button='left', delay=0.1)
                                                                                time.sleep(0.5)
